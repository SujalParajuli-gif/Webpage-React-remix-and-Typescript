        ...
        >
          ...
          <a href="#" className="group">
            <div className="flex items-center gap-2">
              {/* NEW: add important color override to follow top/scroll state while keeping original classes */}
              <IoIosMail
                className={[
          ...
          <a href="#" className="group">
            <div className="flex items-center gap-2">
              {/* NEW: same important override for the phone icon */}
              <FaPhone
                className={[
