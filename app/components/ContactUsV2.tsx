              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:space-x-6  ">
                  ...
                  <div className="flex-1 md:mb-0 ">
                    <label className="block text-[16px] mb-2">Full Name</label>
                    <input
                      type="text"
                ...
                <div className="flex items-start space-x-2 text-lg text-[#1F1F1F]">
                  ...
                  <p className="leading-relaxed text-[13px] md:text-[14px]">
                    ...
                    commercial purposes in Matat Technologies Ltd.'s databases
                    in{" "}
                    <Link
                      to="/privacy-policy"
                    ...
                    . I am not obligated to provide the information in
                    accordance with the law, but without providing the
                    information we will not be able to contact you or handle
                    your request.
                  </p>
                </div>
