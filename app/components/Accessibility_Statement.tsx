// app/components/Accessilibity_Statement.tsx
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <section className="space-y-2">
                ...
                <p className="leading-7">
                  We invest a lot of resources to make this site accessible in order to enable the browsing experience for the general population and people with disabilities in particular.
                  The motto that guides us is human dignity and freedom, as this is a cornerstone of Israeli society because we are all equal in our essence rights.
                </p>
              </section>

              {/* 2 */}
              <section className="space-y-2">
                <h2><span className="num">2&nbsp;</span>Use of the accessibility component</h2>
                <p className="leading-7">
                  This website includes an accessibility plugin that helps make the site accessible to people with disabilities.
                </p>
              </section>

              {/* 3 */}
              <section className="space-y-3">
                <h2><span className="num">3&nbsp;</span>Menu User Manual</h2>
                <BlueList
                  items={[
                    <>Site Customization Button and Site Tags for Assistive Devices and Technologies for People with Disabilities</>,
                    <>Enable navigation with the keyboard keys between the links on the website</>,
                    ...
                    <>A button that clearly highlights all the title tags that appear on the website</>,
                    <>A button that clearly emphasizes all the links that appear on the website</>,
                    <>A button that displays the alternate description of all the images that appear on the site with a mouse hover</>,
                    <>A button that displays a permanent description of the images on the website</>,
              ...
              {/* 4 */}
              <section className="space-y-3">
                <h2><span className="num">4&nbsp;</span>Keyboard functions and magnification</h2>
                <p className="leading-7">
                  There are 2 types of magnification in the accessibility bar for your convenience, but if you want to enlarge the letters further, you can use the following keyboard functions:
                </p>
                <BlueList
                  items={[
                    ...
                    <>The F11 key will increase the screen to full size – another press will make it smaller again.</>,
                  ]}
                />
              </section>
              ...
              {/* 5 */}
              <section className="space-y-2">
                <h2><span className="num">5&nbsp;</span>For the avoidance of doubt</h2>
                <p className="leading-7">
                  We are committed to making our websites accessible to all people, people with abilities and disabilities.
                  On this website, you can find the right technology for your needs.
                  This site is usable for the majority of the population and with maximum effort.
                  You may find elements that are not accessible because they have not yet been made accessible or a suitable technology has not been found, and at the same time, we ensure that most efforts are made to improve and make them accessible at a high level and without compromise.
                  If you encounter any difficulty browsing the site and viewing our content, we apologize and we will be very happy for you to draw our attention to this.
                </p>
              </section>

              {/* 6 */}
              <section className="space-y-2">
                <h2><span className="num">6&nbsp;</span>For any questions about accessibility</h2>
                <p className="leading-7">
